# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 15:46:12 2020

@author: ronny.merchan
"""
...
wait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[text()='Poll/Map']"))).click()
...
for i in list3:
    ...
    for row in soup.find_all("tr")[1:]:
        ...
        df = pd.DataFrame(datasets,columns=['Poll', 'Date', 'Sample', 'MoE', 'Democratic Party', 'Republican Party', 'Spread', 'Election Year'])
